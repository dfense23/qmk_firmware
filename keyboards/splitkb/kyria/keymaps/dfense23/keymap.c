 ...
 */
 ...
 //     ),
     ...
     [_COLEMAK_DH] = LAYOUT_split_3x6_5(
         ...
         KC_LSFT, KC_Y, KC_X, KC_C, KC_D, KC_V,              KC_ESC, KC_NO,                             KC_NO, TT(MOUSE),          KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                                 TO(COLEMAK), KC_DEL, TT(NAV), KC_SPC, TT(NUM),                                    TT(SYM), KC_ENT, TT(NAV), TT(NUMPAD), TO(GAME)),
     ...
     [_NAV] = LAYOUT_split_3x6_5(
         ...
         KC_TRNS, KC_LEFT_GUI, KC_LEFT_ALT, KC_LEFT_SHIFT, KC_LEFT_CTRL, KC_TRNS,                             KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_TRNS, KC_TRNS,
     ...
     [_GAME] = LAYOUT_split_3x6_5(
         ...
         KC_TRNS, KC_1, KC_2, KC_3, KC_4, KC_M,                                  KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                 KC_TRNS, KC_TRNS, KC_LCTL, KC_TRNS, KC_TRNS,                              TO(COLEMAK), TO(ADJUST), KC_TRNS, KC_TRNS, KC_TRNS),
